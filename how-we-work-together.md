...
This document captures the typical responsibilities we accept when we are performing three particular disciplines on a project:
...
As we manage a project, we have a unique perspective and opportunity to develop our business *while* we develop the business of our clients. This is a balance of building mutually beneficial, valuable situations between Sparkbox and our customers as we...
...
* Promote the next project phase during current phase
...
* For the team working on the project
    ...
    * Set the team up for success
        ...
        * Do whatever possible to unblock work
...
* For the client
    ...
    * Help the point of contact look good
...
* For Sparkbox
    ...
    * Give and receive critique on project management practices and active projects
        ...
        * Incorporate critique into projects or PM practices
...
* Establishing a project cadence
    ...
    * Own project management tools (like Basecamp and Jira)
...
* Making sure we are building the right thing
...
Many Sparkboxers are involved in initial staffing, budget, and timeline conversations. However, a project manager assumes the ongoing responsibility for these aspects of a project’s health once the project begins. This ensures that these critical pieces of the project are being overseen by the person closest and most familiar with the project. As a project manager, one should...

* Ensure that the project is and remains staffed appropriately

    * Work with projects and ops teams to identify the appropriate team
...
* For the client
    ...
    * Do a responsible amount of research on the industry and competitors to ensure that we’re armed with the right information before design begins
...
* For Sparkbox
    ...
    * Let PMs know status regularly and if more time is needed as early as possible

    * Give valuable, honest feedback in design reviews
...
* Participate in the design review before the concept is presented to client
    ...
    * Remember that all team members serve to make the project better

* Ensure the concept is buildable within the timeline and budget before presenting it to the client

    * Involve the right people who can give input on the effort to build a design concept

* Present design concepts to the client with a detailed explanation of reasons behind visual choices

    * Talk about the why, not the what

    * Reiterate the visual vocabulary

    * Discuss how the presented concept will help accomplish the project goals

    * If the client doesn’t agree with our rational, we listen and make every effort to address their concerns

    * We believe it is acceptable and our job to respectfully push back and give reasons why when we feel strongly that a client suggestion is detrimental to the project

* Communicate to/educate the client that the end goal is browser

    * Different browsers render fonts and colors differently
...
* Transfer ownership of assets
    ...
    * fonts, photography (help client make necessary typography and image purchases)
...
* Help PMs know the level of effort required for outstanding Github issues and break issues into multiple cards when necessary

* Predict and communicate what will be hard to build and have a backup plan

* Know when to compromise design where needed and know when to push back
...
* Facilitate team productivity by
    ...
    * being aware of and available to team members as reflected in Forecasted hours
...
In support of **creating, reviewing, and giving feedback**, during a project, we know it is essential to…
...
* Support a high fidelity design vision by
    ...
    * pairing with designers to understand design vision and implement it effectively
...
* Support the maintainability, resiliency, and quality of a codebase by

    * implementing an [automated build pipeline](https://github.com/sparkbox/standard/blob/master/build_process/README.md) that ensures ever growing confidence in changes introduced into the project
...
* Leveling up our teammates and client teams as well as clarifying our own understanding through in-project mentorship, pairing, and demos
...
* Giving [thoughtful responses on Pull Requests](https://seesparkbox.com/foundry/stop_giving_depressing_code_reviews) and Slack questions, such as
    ...
    * providing examples or pseudo code to help get a point across
...
* Enable experimentation, prototyping, learning, and discovery through
    ...
    * utilizing [timeboxes](https://www.agilealliance.org/glossary/timebox/) to avoid "spinning" and budget killers
